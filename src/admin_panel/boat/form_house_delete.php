...
if(isset($_GET['data'])){
    ...
    if(!isset($st->id)){
        ...
        echo "<a href='table_boat_house.php'>Zurück</a><br><br>";
        echo "</div>";
        ...
        if($st->id == 0){
            ...
            echo "<a href='table_boat_house.php'>Abbrechen</a><br><br>";
            echo "</div>";
            ...
            if(db_boat_isUsedHouse($st->id)){
                ...
                echo "<a href='action_house_delete.php?data=".$_GET['data']."'>Löschen</a><br><br>";
                echo "<a href='table_boat_house.php'>Abbrechen</a><br><br>";
                echo "</div>";
