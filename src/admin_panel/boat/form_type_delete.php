...
if(isset($_GET['data'])){
    ...
    if(!isset($st->id)){
        ...
        echo "<a href='table_boat_type.php'>Zurück</a><br><br>";
        echo "</div>";
        ...
        if($st->id == 0){
            ...
            echo "<a href='table_boat_type.php'>Abbrechen</a><br><br>";
            echo "</div>";

        }else{
            if(db_boat_isUsedType($st->id)){
                ...
                echo "<a href='action_type_delete.php?data=".$_GET['data']."'>Löschen</a><br><br>";
                echo "<a href='table_boat_type.php'>Abbrechen</a><br><br>";
                echo "</div>";
