...
if(isset($_GET['group'])){
            if(db_account_isUsingGroup($_GET['group'])){
                ...
                echo "<a href='action_group_delete.php?data=".$_GET['group']."'>Löschen</a><br><br>";
                echo "<a href='table_groups.php'>Abbrechen</a><br><br>";
                echo "</div>";
            }
}else{
