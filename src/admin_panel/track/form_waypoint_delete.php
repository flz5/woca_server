...
if(isset($_GET['data'])){
    ...
    if(!isset($st->id)){
        ...
        echo "<a href='table_waypoint.php'>Zurück</a><br><br>";
        echo "</div>";
        ...
        if($st->id == 0){
            ...
            echo "<a href='table_waypoint.php'>Abbrechen</a><br><br>";
            echo "</div>";
                ...
                echo "<a href='action_waypoint_delete.php?data=".$_GET['data']."'>Löschen</a><br><br>";
                echo "<a href='table_waypoint.php'>Abbrechen</a><br><br>";
                echo "</div>";
