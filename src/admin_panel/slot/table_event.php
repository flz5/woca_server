...
<a href="..\index.php">Start</a> > <a href="index.php">Teilnahmen</a> > Events<br><br>
<a href="table_training.php">Training</a> <br> <br>
...
<table border="1">
    ...
    if(isset($list)){
        foreach ($list as $bb){
            ...
            $json = json_encode($bb);
            echo "<a href='form_slot_event_delete.php?id=".$bb->id."'>Löschen</a></td>";
