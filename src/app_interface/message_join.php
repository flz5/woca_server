...
if(isset($_GET['session']) and isset($_GET['channel']) and isset($_GET['type']) and isset($_GET['device_id'])){
    ...
    if(ss_account_isLoggedIn()){
        ...
        if($message->isChannelJoinable($_GET['channel'])){
            $message->joinChannel($_GET['channel'],$_GET['type'],$_GET['device_id']);
